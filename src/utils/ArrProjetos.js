...
export const arrBackend = [
  {
    ...
    description: 'O Trybe Futebol Clube (TFC) é um portal de futebol com recursos de gerenciamento de partidas, classificações detalhadas e login seguro, desenvolvido com tecnologias avançadas como TypeScript, Sequelize, MySQL e Node.js.',
  },
  {
    name: 'Blogs API',
    url: 'https://github.com/thiago-papim/project-blogs-api',
    description: 'O Blogs API é um avançado sistema de gerenciamento de posts e usuários! 📖 Nele, os usuários podem realizar diversas ações, como criar, ler, atualizar e deletar posts, tudo isso com a segurança de um sistema de login, onde somente o usuário que criou o post tem permissão para deletá-lo ou atualizá-lo.',
  },
  {
    name: 'Store Manager',
    url: 'https://github.com/thiago-papim/project-store-manager',
    description: 'Este projeto consiste no desenvolvimento de uma API RESTful de gerenciamento de vendas, com foco na criação, visualização, atualização e exclusão de produtos e vendas. A principal tecnologia utilizada é o banco de dados relacional MySQL para armazenar e gerenciar os dados.',
  },
  {
    name: 'Trybe Smith',
    url: 'https://github.com/thiago-papim/tribesmith',
    description: 'Este projeto visa desenvolver uma API para gerenciar itens medievais, seguindo o padrão CRUD (Create, Read, Update e Delete). A aplicação está escrita em TypeScript e utilizará o Sequelize, um ORM (Object-Relational Mapping), para interagir com um banco de dados.',
  },
  {
    name: 'MySQL All for One',
    url: 'https://github.com/thiago-papim/mysql-all-for-one',
    description: 'O "MySQL All for One" é um projeto incrível do meu portfólio, consistindo em 27 desafios de consultas SQL desenvolvidos para aprimorar minhas habilidades em manipulação de dados no banco de dados MySQL.',
  },
  {
